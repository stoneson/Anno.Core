...
{
    public class RabbitSubscribeConfig : SubscribeConfig
    {
        public RabbitSubscribeConfig() :
            base()
        {
        }
        /// <summary>
        ...
        public RabbitSubscribeConfig(string server, string username, string password, int port, Enums.RabbitExchangeType exchangeType
        ...
        /// </summary>
        public int RequestedHeartbeat { get; set; } = 5000;
